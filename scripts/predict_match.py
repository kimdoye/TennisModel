...
if __name__ == '__main__':
    ...
    load_dotenv()    #python predict_match.py "NovakDjokovic" "CarlosAlcaraz" --surface Clay --level M --best_of 5
    # python scripts/predict_match.py "NovakDjokovic" "CarlosAlcaraz" --surface Clay --level M --best_of 5
